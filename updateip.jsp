    ...
    <head>
        ...
        <script type="text/javascript">  
            ...
            { 
              ...
              if(cat=="")
                 document.getElementById("note1").innerHTML="Enter an IP Address";             
              else if(reg.test(cat))
                 document.getElementById("note1").innerHTML="Your IP Adress  violated the rule";
             else{
              ...
              xmlhttp.open("POST","updateip?sno="+sno+"&type="+type+"&ip="+cat,true);
              xmlhttp.send();       
             }              
               }
        </script>
            ...
            <div id="content_cen"> 
             <div style="float:left"><img src="./images/logoback1.png" style="position:absolute; z-index:1; width:600px; height:400px; margin-top:0px; margin-left:70px"/></div>
              ...
              <center>  <table align="center" border="0" style="width:400px;">
                ...
                %>
                <tr>
                <td colspan="5" align="center"> <b style="color:red"><u>Note:</u></b></br></br>The IP Address should only contain ,numbers{0-9} and probably ":" symbol </td> 
                </tr> 
                <tr>
