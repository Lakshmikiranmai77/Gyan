<%-- 
    Document   : addlc
    Created on : 21 May, 2014, 4:25:40 PM
    Author     : ETTC-COMPUTER LAB
--%>
...
String qry = "insert into loco(topic) values('"+topic+"')";
...
if(val>0)
{
 out.println("<center><span style='color:green;'>Loco Inspector Inserted successfully</span></center>");
}
           ...
           function validate()
            {
             ...
             </br></br><center><font size="3"><b><i style="position:absolute; margin-left:-30px">Add Loco Inspector</b></i></font></center></br>  
             ...
             <table style="margin-left:165px" border="0">
               ...
               <tr>
                   <td>
                     <b style="color:red"><u>Note:</u></b>The category should only contain alpahabets{A-Z}/{a-z} and probably white spaces{" "} 
                   </td>
               </tr>
              </table>   
              </form>
