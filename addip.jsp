...
String qry = "insert into mysql.ipaddress(ipaddr) values('"+ip+"')";
//out.println("qry : " + qry);
...
if(val>0)
{
 out.println("<center><span style='color:green;'>IP Adress inserted successfully</span></center>");
}
           ...
           function validate()
            {
             ...
             var reg=new RegExp("[\x20-\x2F]|[\x3B-\x40]|[\x5B-\x60]|[\x7B-\x7E]|[\x41-\x5A]|[\x61-\x7A]");
             if(cat=="")
                 document.getElementById("note").innerHTML="Enter an IPAddress";
             if(reg.test(cat))
                 document.getElementById("note").innerHTML="Your IPAddress violated the rule";  
             else 
                  return true;
             return false; 
             ...
             </br></br><center><font size="3"><b><i style="position:absolute; margin-left:-30px">Add IPAddress</b></i></font></center></br>  
             <center><span id="note"  style="color:red"></span></center></br>

             <table style="margin-left:165px" border="0">
               <tr>    
                   <td> <span><b><i>Enter the IPaddress&nbsp;&nbsp;&nbsp;:</i\></b></span><input type="text" id="cat" name="ca"/></td>
               </tr> 
               <tr>
               ...
               <tr>
                   <td>
                     <b style="color:red"><u>Note:</u></b>The IPAddress should only contain numbers{0-9} and probably ":" symbol
                   </td>
               </tr>
              </table>   
              </form>
