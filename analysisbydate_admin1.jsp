            ...
            function generateChartData() {
                  ...
                  String pfno=request.getParameter("pfno");
                     try{
                        ...
                        ResultSet rs=st.executeQuery("select distinct millisec from mysql.store where pfno='"+pfno+"' ORDER BY date"); 
                        ResultSet rs1;                                              
                        String date;
                        
                        while(rs.next())
                          {
                            date=rs.getString("millisec");
                            rs1=st1.executeQuery("select percentage as percent from mysql.store where millisec='"+date+"' and pfno='"+pfno+"'");
                            rs1.next();
                          %>    
                          chartData.push({        
                          date: new Date(<%=date%>),
        ...
        <div id="head">
            <div id="head_cen">
                <div id="head_sup" class="head_height">
                    ...
                    <p style="">&nbsp;</p>
                    <p style="">&nbsp;</p>
                    <center><img src="./images/title.jpg" style="width:940px; margin-top:-45px; margin-left: -60px"/></center>
