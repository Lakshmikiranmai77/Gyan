...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript">
            ...
            var chartData = [
                  <%
                     String pfno=(String)request.getParameter("pfno");
                     try{
...
<div id="chartdiv" style="padding-top:30px; margin-bottom:50px ; margin-left:-30px; color:black; width: 500px; height:350px; margin: 0 auto"></div>                
             </div>
            </div>
        </div>
        <div id="foot">
