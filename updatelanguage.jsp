...
<html xmlns="http://www.w3.org/1999/xhtml">
 <%@page language="java" import="java.sql.*" %>
    ...
    <head>
        ...
        <script type="text/javascript" src="updateques.js"></script>
        ...
        <script type="text/javascript">  
            ...
            function mysubmit(element)
            {
              ...
              if(n==0)
                 var lang=document.getElementById(sno).innerHTML;
             else
                 var lang=document.getElementById(sno+"t").value;
              //document.getElementById("note").innerHTML=type+" "+sno+" "+text;
                
             var reg=new RegExp("[\x20-\x2F]|[\x3A-\x40]|[\x5B-\x60]|[\x7B-\x7E]|[\x30-\x39]");
             if(lang=="")
                 document.getElementById("note1").innerHTML="Enter a Language";
             if(reg.test(lang))
                 document.getElementById("note1").innerHTML="Your Language name violated the rule";  
             else 
                 {
              var xmlhttp;
              ...
              if (xmlhttp.readyState==4 && xmlhttp.status==200)
                 { 
                   ...
                   document.getElementById(sno+"td").innerHTML="<p id='"+sno+"' onclick='change(this)'>"+lang+"</p>"; 
                   n=0;                   
                 }
                 }
         
              xmlhttp.open("POST","updatelang?sno="+sno+"&type="+type+"&lang="+lang,true);
              xmlhttp.send(); 
                 }
               }
        </script>
            ...
            <div id="content_cen">   
             <div style="float:left"><img src="./images/logoback1.png" style="position:absolute; z-index:1; width:600px; height:400px; margin-top:0px; margin-left:70px"/></div>
              ...
              <center>  <table align="center" border="0" style="width:400px;">
                ...
                try{
                 ...
                 Statement stmt;                   
                   ...
                   if(con==null)
                    ...
                    ResultSet rs=stmt.executeQuery("select * from mysql.language");
                    while(rs.next())
                    {
                ...
                %>
                <tr>
                <td colspan="5" align="center"> <b style="color:red"></br></br><u>Note:</u></b>The language should only contain alhabets</br> [A-Z]/[a-z]  </td> 
                </tr> 
                <tr>
