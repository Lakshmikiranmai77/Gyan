...
String qry = "insert into register(password,name,pfno,desg,dept,loc,lname,grade) values('"+pfno+"','"+emp+"','"+pfno+"','"+desg+"','"+dept+"','"+loc+"','"+lname+"','"+grade+"')";
...
e.printStackTrace();
	...
	<td align="center"></br><input type="submit" name="submit" value="Submit"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="reset" name="reset" value="Reset"/></td>
	</tr>
