...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <span style="font-weight:bold; font-size:16px">Enter Old Password    :</span>   <input size="20" id="old" type="text"/>
    
    <span style="font-weight:bold; font-size:16px">Enter New Password    :</span>   <input size="20" id="new" type="text" />  
    
    <span style="font-weight:bold; font-size:16px">Re enter New Password :</span>   <input size="20" id="new1" type="text" />
